...
/**
 The base class for all bookApp modules
 */
...
/**
 bookApp Platform calls this method on startup.
 */
-(void)startup;

/**
 bookApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 bookApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 bookApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
