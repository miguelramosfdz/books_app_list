 ...
 * Copyright (c) 2009-2011 by bookApp, Inc. All Rights Reserved.
...
//@interface bookAppObject : NSObject
//@end

@interface bookAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[bookAppObject class]])
		{
			for (NSString *key in [[(bookAppObject*)o modules] allKeys])
			{
