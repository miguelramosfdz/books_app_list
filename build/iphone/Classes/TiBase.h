...
// in simulator we redefine to format for bookApp Developer console
...
{\
	NSString * exceptionName = [@"org.bookapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bookapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIbookAppNativeItemNone = -1, 
	UIbookAppNativeItemSpinner = -2,
	UIbookAppNativeItemProgressBar = -3,
	
	UIbookAppNativeItemSlider = -4,
	UIbookAppNativeItemSwitch = -5,
	UIbookAppNativeItemMultiButton = -6,
	UIbookAppNativeItemSegmented = -7,
	
	UIbookAppNativeItemTextView = -8,
	UIbookAppNativeItemTextField = -9,
	UIbookAppNativeItemSearchBar = -10,
	
	UIbookAppNativeItemPicker = -11,
	UIbookAppNativeItemDatePicker = -12,
	
	UIbookAppNativeItemInfoLight = -13,
	UIbookAppNativeItemInfoDark = -14,
	
	UIbookAppNativeItemDisclosure = -15,
	
	UIbookAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all bookApp instances of
