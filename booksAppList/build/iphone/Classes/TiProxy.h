...
//Rare exceptions to indicate a bug in the _booksapplist code (Eg, function that a subclass should have implemented)
...
/**
 The base class for booksAppList proxies.
 */
