...
// in simulator we redefine to format for booksAppList Developer console
...
{\
	NSString * exceptionName = [@"org.booksapplist." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.booksapplist";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIbooksAppListNativeItemNone = -1, 
	UIbooksAppListNativeItemSpinner = -2,
	UIbooksAppListNativeItemProgressBar = -3,
	
	UIbooksAppListNativeItemSlider = -4,
	UIbooksAppListNativeItemSwitch = -5,
	UIbooksAppListNativeItemMultiButton = -6,
	UIbooksAppListNativeItemSegmented = -7,
	
	UIbooksAppListNativeItemTextView = -8,
	UIbooksAppListNativeItemTextField = -9,
	UIbooksAppListNativeItemSearchBar = -10,
	
	UIbooksAppListNativeItemPicker = -11,
	UIbooksAppListNativeItemDatePicker = -12,
	
	UIbooksAppListNativeItemInfoLight = -13,
	UIbooksAppListNativeItemInfoDark = -14,
	
	UIbooksAppListNativeItemDisclosure = -15,
	
	UIbooksAppListNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all booksAppList instances of
