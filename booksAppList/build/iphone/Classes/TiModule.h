...
/**
 The base class for all booksAppList modules
 */
...
/**
 booksAppList Platform calls this method on startup.
 */
-(void)startup;

/**
 booksAppList Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 booksAppList Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 booksAppList Platform calls this method on resume.
 @param sender The sender of the event.
 */
