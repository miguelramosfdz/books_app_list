 ...
 * Copyright (c) 2009-2011 by booksAppList, Inc. All Rights Reserved.
...
//@interface booksAppListObject : NSObject
//@end

@interface booksAppListObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[booksAppListObject class]])
		{
			for (NSString *key in [[(booksAppListObject*)o modules] allKeys])
			{
