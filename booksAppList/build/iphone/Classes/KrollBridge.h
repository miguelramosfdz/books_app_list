...
@interface booksAppListObject : KrollCoverageObject {
#else
@interface booksAppListObject : KrollObject {
#endif
@private
...
extern NSString * booksAppList$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	booksAppListObject *_booksapplist;
	BOOL shutdown;
